...
then
    CUDA_VISIBLE_DEVICES=2 python main.py --dataset $dataset --snap_size 1000 --train_ratio 0.5 --anomaly_ratio $anomaly_ratio  \
    --epoch 200 --lr 0.001 --initial_epochs 60 --iter_num 5 --iter_epochs 60 \
...
then
    CUDA_VISIBLE_DEVICES=4 python main.py --dataset $dataset --snap_size 2000 --train_ratio 0.5 --anomaly_ratio $anomaly_ratio  \
    --epoch 200 --lr 0.001 --initial_epochs 60 --iter_num 5 --iter_epochs 60 \
    --x_dim 256 --h_dim 256 --z_dim 256 

elif [[ "$dataset" == "as_topology" ]]; 
then
    CUDA_VISIBLE_DEVICES=5 python main.py --dataset $dataset --snap_size 6000 --train_ratio 0.5 --anomaly_ratio $anomaly_ratio  \
    --epoch 200 --lr 0.001 --initial_epochs 60 --iter_num 5 --iter_epochs 60 \
